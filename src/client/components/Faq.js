            ...
            <div className="accordion" id="faqExample">
              <div className="card">
                <div className="card-header p-2" id="headingOne">
                  <h5 className="mb-0">
                    <button
                      className="btn btn-info btn-lg btn-block text-left"
                      Type="button"
                ...
                >
                  <div className="card-body">
                    <ul>
                      ...
                      <li>
                        Encouraging students to engage actively with their
                        topics to build deeper understanding.
                      </li>
                      <li>
                        Helping build student confidence in their ability to
                        learn and to understand challenging concepts.
                      </li>
                    </ul>
                  </div>
                </div>
              ...
              <div className="card">
                <div className="card-header p-2 text-center" id="headingTwo">
                  <h5 className="mb-0">
                    <button
                      className="btn btn-info btn-lg collapsed btn-block text-left"
                      type="button"
                      data-toggle="collapse"
              ...
              <div className="card">
                ...
                >
                  <div className="card-body">
                    <p>
                      Tutor.com allows you to create a flexible schedule that
                      fits your needs. Our service is available 24 hours a day,
                      7 days a week, which means you can create a new schedule
                      on a week-to-week basis. There are three ways to tutor:
                    </p>
                    <ul>
